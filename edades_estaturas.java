...
public class edades_estaturas {
    public static void main(String[] args) {
        ...
        System.out.println(
                "La media de las edades es :" + medad + ", Existen " + contador18 + " personas mayores de edad.");
        System.out.println("La media de las estaturas es :" + mestatura + ", Existe " + contador_altura
                + " personas con una estatura mayor a 1.75cm.");
